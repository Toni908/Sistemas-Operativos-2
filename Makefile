...
PROGRAMS=mi_mkfs leer_sf escribir leer permitir truncar mi_mkdir mi_chmod mi_ls mi_stat mi_touch mi_escribir mi_cat mi_escribir_varios prueba_cache_tabla mi_link mi_rm mi_rmdir #simulacion verificacion
OBJS=$(SOURCES:.c=.o)
